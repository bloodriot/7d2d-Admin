...
public class End extends Event {
    ...
    @Inject
    public End(final Configuration configuration, final EventBus eventBus) {
        super(configuration, eventBus);
        setEventType(EventTypes.HORDE_END);
    }

    @Override
    public void onEventTriggered(EventData event) {
        System.out.println(this.toString());
        System.out.println(getConfiguration().getProperty("blood-moon-end"));
    }
